                ...
                <div class="w-full m-auto py-8">
                    <?php while ($lastBlog->have_posts()) : $lastBlog->the_post(); ?>
                        <div class="border-y-[1px] border-x-[0.5px] bg-white border-gray-200 border-collapse p-4 mb-3 ">
                            ...
                            ?>
                            <div class="flex max-md:flex-wrap relative text-gray-500" id="post-header">
                                ...
                                <p class="leading-8 mr-2">Asked on: <?php echo $date_variable; ?> | </p>
                                <a class="leading-8 mr-2">In: <?php echo $cat_name ?> | </a>
                                <div class="flex">
                                    <a class="leading-8 mr-2">Posted by:
                                        <?php echo '<a class="leading-8 mr-2 hover:text-sky-600 max-md:text-sky-600" href="' . $author_url . '">' . get_the_author() . '</a>'; ?></a>
                                </div>
                            ...
                            <div class="text-gray-800 w-full m-auto my-2" id="post-content">
                                <h2 class="mb-2 font-bold"><?php echo $title_variable; ?></h2>
                                <p class="">
                            ...
                            <div class="flex justify-between  min-h-[40px] items-center w-full mx-auto">
                                ...
                                <a id="answer-button" class="min-w-[80px] h-[35px] bg-black text-white flex justify-center items-center mr-3 rounded" href="<?php echo the_permalink(); ?>">Answer</a>
                            </div>
                        </div>
                    <?php endwhile; ?>
                </div>
                    ...
                    <?php foreach ($category_relation_pagination as $value) : ?>
                        <div class="border-y-[1px] border-x-[0.5px] bg-white border-gray-200 border-collapse p-4 mb-3">
                            ...
                            <div class="flex max-md:flex-wrap relative text-gray-500" id="post-header">
                                <img class="w-8 h-8 rounded-3xl mr-2 border-sky-600 border-2 p-[1px]" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="user profile">
                                <p class="leading-8 mr-2">Asked on: <?php echo $date_variable; ?> | </p>
                                <a class="leading-8 mr-2">In: <?php echo $getslug ?> |</a>
                                <a class="leading-8 mr-2">Posted by:
                            ...
                            <div class="flex justify-between min-h-[40px] items-center w-full mx-auto">
                                ...
                                <a id="answer-button" class="min-w-[80px] h-[35px] bg-black text-white flex justify-center items-center mr-3 rounded" href="<?php echo the_permalink($value->ID); ?>">Answer</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                    <!-- Pagination -->
