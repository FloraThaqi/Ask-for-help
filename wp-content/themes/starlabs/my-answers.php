  ...
  foreach ($comments as $comment) {
    ...
    if(isset($_POST['edit']) && $_POST['comment_id'] == $comment->comment_ID) {
      ...
      echo '<div class="flex justify-end min-h-[40px] items-center w-full mx-auto">
        ...
        <button class="bg-red-500 text-white p-2 rounded" onClick="showModal()">Delete</button>

<div id="deleteModal" class="hidden fixed top-0 left-0 w-full h-full flex items-center drop-shadow-2xl justify-center">
  <div class="bg-white p-6 rounded">
    ...
    <form action="" method="post">
    <input type="hidden" name="comment_id" value="'.$comment->comment_ID.'">
    <input type="submit" name="delete" value="Delete" class="bg-red-500 text-white p-2 rounded">
