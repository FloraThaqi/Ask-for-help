...
<footer class="bg-slate-200 dark:bg-[#0b1523] text-black dark:text-white">
        ...
        <div class="w-60 flex">
            <a href="<?php echo home_url(); ?>">
                ...
                if (!empty($footer_logo)) : ?>
                    <img class="object-contain" src="<?php echo esc_url($footer_logo['url']); ?>" alt="<?php echo esc_attr($footer_logo['alt']); ?>" />
                <?php endif; ?>
            </a>
        </div>
                    ...
                    <?php if ($list_1) :
                        foreach ($list_1 as $links) : ?>
                            <?php if (is_array($links['links'])) : ?>
                                <li class="mb-4  dark:text-slate-300 dark:hover:text-white"><a href="<?= $links['links']['url'] ?>" class=" "><?= $links['links']['title'] ?></a></li>
                    <?php endif;
                        endforeach;
                    endif; ?>
                </ul>
    ...
    <div class="my-div text-center py-8">
        <div class="content-center justify-center mb-6">
            <a href="<?php the_sub_field('facebook_link'); ?>" type="button" class="rounded-full border-2 border-black leading-normal uppercase hover:bg-black dark:border-white dark:hover:bg-blue-400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
            ...
            <a href="<?php the_sub_field('twitter_link'); ?>" type="button" class="rounded-full border-2 border-black leading-normal uppercase  hover:bg-black dark:border-white dark:hover:bg-blue-400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
            ...
            <a href="<?php the_sub_field('linkedin_link'); ?>" type="button" class="rounded-full border-2 border-black leading-normal uppercase  hover:bg-black dark:border-white dark:hover:bg-blue-400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
            ...
            <a href="<?php the_sub_field('github_link'); ?>" type="button" class="rounded-full border-2 border-black leading-normal uppercase  hover:bg-black  dark:border-white  dark:hover:bg-blue-400 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
