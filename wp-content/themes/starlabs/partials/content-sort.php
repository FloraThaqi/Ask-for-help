...
<div class="flex justify-end mb-7">
    ...
    <div class="hidden bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4" id="dropdown">
        <ul class="py-1" aria-labelledby="dropdown">
            <li>
                <a href="?sort=newest" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Newest to
                    Oldest</a>
            </li>
            <li>
                <a href="?sort=oldest" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Oldest to
                    Newest</a>
            </li>
            <li>
                <a href="?sort=liked" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Most
                    liked</a>
            </li>
        </ul>
    </div>
