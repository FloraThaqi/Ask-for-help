<?php
        ...
        $phonenumber = $module['phone_number'];
        $email = $module['email'];
    ...
    <div class="container flex flex-col min-h-screen px-6 py-12 mx-auto">
        <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div class="text-white lg:w-1/2 lg:mx-6">
                <h1 class="text-2xl font-semibold capitalize lg:text-3xl"><?php echo $title ?></h1>

                <p class="max-w-xl mt-6"><?php echo $paragraph ?></p>
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72"><?php echo $phonenumber?></span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72"><?php echo $email ?></span>
                    </p>
                </div>
                ...
                <div class="mt-6 md:mt-8">
                    ...
                    <a class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="<?php echo $socials['facebook'];?>" target="_blank">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                            </svg>
                        </a>
                     <a class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="<?php echo $socials['twitter'];?>" target="_blank">
                    ...
                    <a class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="<?php echo $socials['instagram'];?>" target="_blank">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="<?php echo $socials['linkedin'];?>">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
