...
?>
    <div class="w-full">
        <h1 class=" tracking-normal normal-case font-bold text-5xl text-center mt-10 mx-auto mb-0"><?php echo $title ?></h1>
        ...
        <div class="w-full">
			<div class="max-w-[1008px] m-auto max-lg:w-11/12 mb-6">
				<div class="grid xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 container m-auto mt-[-174px] max-lg:w-full">
				    <?php foreach($boxes as $box):?>
				        <div class="bg-white rounded-3xl py-6 px-7 shadow-lg mb-8 w-[220px] min-h-[220px] max-lg:m-auto max-lg:w-full">
