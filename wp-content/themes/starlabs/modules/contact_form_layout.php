...
<div class="bg-split-white-blue w-full min-h-[539px] relative flex justify-center items-center">
      <div class="lg:min-h-[377px] lg:w-[965px] w-[340px] my-10 shadow-[0px_0px_20px_-0_rgba(0,0,0,0.15)] h-auto text-left text-[#111111] bg-[#ffffff] rounded-3xl relative flex lg:flex-row justify-center items-start flex-col">
        <div class="max-w-full relative py-7 px-10 flex flex-col flex-1">
          <h1 class="relative normal-case text-5xl font-bold mt-6 mr-auto text-center"><?php echo $title ?></h1>
          <p class="relative text-lg text-[#999999] block lg:mt-12 mt-2.5 leading-8 lg:text-left text-center">
          <?php echo $paragraph ?>
          </p>
          <div class="h-7 min-h-4 w-40 min-w-32 lg:mt-8 lg:ml-0 mt-2.5 relative flex ml-24">
            <a href="<?php echo $socials['facebook'];?>" target="_blank" class="h-full flex-1 cursor-pointer"><span class="h-full flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 112 112" x="0px" y="0px" id="svg-50ee"><path d="M75.5,28.8H65.4c-1.5,0-4,0.9-4,4.3v9.4h13.9l-1.5,15.8H61.4v45.1H42.8V58.3h-8.8V42.4h8.8V32.2 c0-7.4,3.4-18.8,18.8-18.8h13.8v15.4H75.5z"></path></svg></span></a>
