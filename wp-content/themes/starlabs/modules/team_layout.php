            ...
            <div class="container w-full max-w-md bg-white  border-none rounded-3xl m-5 p-5">
                <div class="flex flex-col space-y-5 md:space-y-0 md:space-x-6 md:flex-row ">
                    ...
                    <img src="<?php echo $value['image']['url']; ?>" alt=""
                        class="self-center overflow-auto flex-shrink-0 w-32 h-32 border rounded-full md:justify-self-start md:self-top">
                    <?php else:?>
                    <img src="<?php  echo $default_pic ?>" alt=""
                        class="self-center flex-shrink-0 w-32 h-32 border rounded-full md:justify-self-start ">
                    <?php endif;?>
                ...
                <div class="flex justify-center pt-4 space-x-4 align-center">
                    ...
                    <a rel="noopener noreferrer" href="<?php echo $value['link']['url'] ?>"
                        target=<?php echo $value['link']['target'] ?> aria-label="Dribble"
                    ...
                    <a rel="noopener noreferrer" href="#" aria-label="Twitter" class="p-1 rounded-full bg-[#4767C9] ">
                    ...
                    <a rel="noopener noreferrer" href="#" aria-label="Email" class="p-1 rounded-full bg-[#4767C9]">
