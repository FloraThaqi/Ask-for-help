...
<body class="bg-gray-100 font-display ">
    ...
    <nav class="bg-white shadow-lg w-full fixed z-50 h-16 ">
        <div class=" md:container flex flex-wrap items-center justify-between mx-auto px-4  ">
            ...
            <!-- Burger Menu -->
            <button type="button" class="mobile-menu-button inline-flex items-center p-2 ml-3 rounded-lg md:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200  " aria-expanded="false">
