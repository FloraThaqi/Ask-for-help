<div class="bg-indigo-500" >
    <h5 class="mt-16 pt-12 leading-3 space-y-1.5 font-semibold flex justify-center text-lg text-white">Get Started</h5><br>
    ...
    <p class=" text-white flex justify-center">Copyright 2021 nicepage.com •  <a class="underline underline-offset-1"> Terms of Service • </a> <a class="ml-1 underline underline-offset-1"> Privacy Policy</a></p>
    </div>
</div>